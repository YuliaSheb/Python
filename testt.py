...
def main():
    ...
    print(f'Callocation method:\n\nCallocation points: {points_list}\n')
    phi_list = []
    j = 1
    ...
    print('Discrete least squares method:\n')
    s = 0
    amount = 100
    ...
    print('Integral least squares method:\n')
